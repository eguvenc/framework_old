...
<strong>Note:</strong> The functions in the above example use the Active Record(CRUD) Class database functions.
...
Your models will typically be loaded and called from within your controller functions. To load a application model you will use the following function:
...
You can connect using the database methods described in database configuration section, either from within your Controller class or your Model class. You must declare <samp>new Db/Db()</samp> function in your model or controller class.
