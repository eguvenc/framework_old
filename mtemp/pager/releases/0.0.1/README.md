...
Also using new Pager(false); boolean you can grab the instance of Obullo libraries,"$this->pager->method()" will not available in the controller.
...
Class Start extends Controller {
    ...
    {                  
        ...
        $perPage = (i\getPost('set_per_page')) ? i\getPost('set_per_page') : '5';
...
```php
<h1><?php echo vi\getVar('title'); ?></h1> 
...
echo '<br />'.$links['all'].'    Per Page '.$perPage_select_box.' ';
...
$data['page_select_box']      = $pager->getPageSelectBox($pageOptions);
$data['per_page_select_box']  = $pager->getPerPageSelectBox(5, 50, 5, false, $perPageOptions); 
```
...
Add this css codes to your view or css file. .myPager {
