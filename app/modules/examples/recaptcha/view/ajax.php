...
<html lang="en">
  <head>
    ...
    <title>ReCaptcha Ajax Form</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="header clearfix">
        ...
        <h2 class="text-muted"><a href="/examples/">ReCaptcha Ajax Form</a></h2>
      </div>

      <div class="content">

        <div id="formHtml">
           <form style="width: 300px;" role="form" action="/examples/recaptcha/ajax" method="POST" id="ajaxForm">
