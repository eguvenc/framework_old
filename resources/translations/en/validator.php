...
return array(
    ...
    'OBULLO:VALIDATOR:ALPHAUNICODE'    => "The %s field may only contain alphabetical characters.",
    'OBULLO:VALIDATOR:ALNUM'           => "The %s field may only contain alpha-numeric characters.",
    'OBULLO:VALIDATOR:ALNUMUNICODE'    => "The %s field may only contain alpha-numeric characters.",
    'OBULLO:VALIDATOR:ALPHADASH'       => "The %s field may only contain alphabetic characters, underscores, and dashes.",
    'OBULLO:VALIDATOR:ALPHADASHUNICODE' => "The %s field may only contain alphabetic characters, underscores, and dashes.",
    'OBULLO:VALIDATOR:ALNUMDASH'       => "The %s field may only contain alpha-numeric characters, underscores, and dashes.",
    'OBULLO:VALIDATOR:ALNUMDASHUNICODE' => "The %s field may only contain alpha-numeric characters, underscores, and dashes.",
