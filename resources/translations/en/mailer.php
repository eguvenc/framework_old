...
return array(
    ...
    'OBULLO:MAILER:API_CALL_FAILED' => 'Mailer api call failed with following parameters: url=%s, error=%s',
    'OBULLO:MAILER:QUEUE_MAILER_PUSH_FAILED' => 'QueueMailer class push failed with following parameters: route=%s',
);