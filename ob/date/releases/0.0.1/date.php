...
namespace Ob\date {
    ...
    * @return	integer
    */
    function gmt2local($time = '', $timezone = 'UTC', $dst = false)
    {			
        if ($time == '')
        {
                return now();
    ...
    * @return	string
    */	
    function unix2human($time = '', $seconds = false, $fmt = 'us')
    {
    ...
    * @return	string
    */	
    function timezoneMenu($default = 'UTC', $class = "", $name = 'timezones')
    {
        if ($default == 'GMT')
        {
            $default = 'UTC';
