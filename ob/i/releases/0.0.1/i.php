...
namespace i {
    ...
    */
    function get($index = '', $xss_clean = false, $use_global_var = false)
    {
        ...
        return \Input\Input::getInstance()->_fetchFromArray($GET, $index, $xss_clean);
    }
    ...
    */
    function post($index = '', $xss_clean = false, $use_global_var = false)
    {
        ...
        return \Input\Input::getInstance()->_fetchFromArray($POST, $index, $xss_clean);
    }
    ...
    */
    function request($index = '', $xss_clean = false, $use_global_var = false)
    {
        ...
        return \Input\Input::getInstance()->_fetchFromArray($REQUEST, $index, $xss_clean);
    }
    ...
    */
    ...
    {
        return \Input\Input::getInstance()->_fetchFromArray($_COOKIE, $index, $xss_clean);
    }
    ...
    */
    function ip()
    {
        return \Input\Input::getInstance()->ip();
    }
    ...
    */
    function validIp($ip)
    {        
        return \Input\Input::getInstance()->validIp($ip);
    }
    ...
    */
    function hmvc()
    {    
        if(\Router\Router::getInstance()->isHmvc())
        {
            return true;
        }
